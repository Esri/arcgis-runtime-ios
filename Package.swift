...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ArcGIS",
            url: "https://developers.arcgis.com/ios/downloads/ArcGIS-iOS-v100.13.xcframework.zip?dl=1",
            checksum: "98231f876f18954fe5426750b2910002f6942a3d6d8fff862abcdff17525f2eb"
        ),
        .binaryTarget(
            name: "Runtimecore",
            url: "https://developers.arcgis.com/ios/downloads/Runtimecore-v100.13.xcframework.zip?dl=1",
